...
description: >-
  ...
  CSS custom property is added or renamed, when dark mode behaviour is
  ...
  pattern and its build-time `--tblr-` prefix, dark mode, the docs
