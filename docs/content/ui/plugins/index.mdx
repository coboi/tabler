...
title: Plugins
order: 7
description: Optional Tabler plugins - charts, calendars, editors, file uploads, social icons and extra theme base colors. Each one needs a file you load on demand.
